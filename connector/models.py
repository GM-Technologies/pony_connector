...
class InvoiceHeader(base_models.AuditModel):
    ...
    customer_code = models.ForeignKey(CustomerMaster, db_column='CUSTCODE')
    balance_amount = models.FloatField(db_column='BALAMT')
    total = models.FloatField(db_column='TOT')
    total_discount = models.FloatField(db_column='TOT_DISC')
    ...
    total_tax_amount = models.FloatField(db_column='TOT_TAXAMT')
    ...
    paid_amount = models.FloatField(db_column='PAIDAMT')
    invoice_amount = models.FloatField(db_column='INVAMT')
    other_charges = models.FloatField(db_column='OTHER_CHGS')
...
class InvoiceDetails(base_models.AuditModel):
    ...
    discount_percentage = models.FloatField(db_column='DISCPERC')
    discount_amount = models.FloatField(db_column='DISCAMT')
    tax_amount = models.FloatField(db_column='TAXAMT')
    net_amount = models.FloatField(db_column='NETAMT')
    ...
    total = models.FloatField(db_column='TOT')
    cgst_per = models.FloatField(db_column='CGSTPER')
    cgst_amount = models.FloatField(db_column='CGSTAMT')
    sgst_per = models.FloatField(db_column='SGSTPER')
    sgst_amount = models.FloatField(db_column='SGSTAMT')
    igst_per = models.FloatField(db_column='IGSTPER')
